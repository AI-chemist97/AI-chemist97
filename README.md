# 👋 안녕하세요, 데이터로 문제를 해결하는 AI-Chemist97입니다.
...
* **ML & Analysis:** `Scikit-learn` (RandomForest, LogisticRegression, PCA, Scalers, class_weight 튜닝)
* **Domain-Specific:** `RDKit` (Cheminformatics)
